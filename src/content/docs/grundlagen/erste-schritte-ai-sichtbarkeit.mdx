...
<Tabs>
<TabItem label="Ja, wenn..." icon="approve-check">
...
<TabItem label="Nein, wenn..." icon="close">
...
1. **robots.txt prüfen** (15 Minuten)
   ...
   **Warum zuerst?** Wenn KI-Crawler blockiert sind, nützt alles andere nichts.
   ...
   <Aside type="tip" title="So geht's">
...
<Tabs>
<TabItem label="Level 2: Fortgeschritten" icon="rocket">
...
<TabItem label="Level 3: Profi" icon="star">
