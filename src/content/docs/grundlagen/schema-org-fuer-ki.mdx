...
<Tabs>
  <TabItem label="Ohne Schema.org" icon="close">
```
...
```
  ...
  <TabItem label="Mit Schema.org" icon="approve-check">
```json
{
  "@type": "Person",
  "name": "Maria Müller",
...
<Tabs>
  <TabItem label="Person" icon="star">
Für Coaches, Berater, Experten:
...
```
  ...
  <TabItem label="Organization" icon="rocket">
...
```
  ...
  <TabItem label="Service" icon="document">
...
```
  ...
  <TabItem label="FAQPage" icon="list-format">
Für FAQ-Seiten:
...
<Aside type="danger" title="Zu wenig Informationen">
```json
// Schlecht
...
<Aside type="danger" title="Falscher Typ">
```json
...
<Aside type="caution" title="Nicht im Head">
