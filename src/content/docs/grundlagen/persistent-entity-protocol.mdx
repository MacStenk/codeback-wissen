...
2. **Keine Identitätssicherheit in dezentralen Systemen**: In einer [Agent Economy](/agent-economy/) interagieren Agenten ohne zentrale Aufsicht. Wie soll Agent B sicherstellen, dass Agent A tatsächlich derjenige ist, für den er sich ausgibt?
...
- **[Agent Economy](/agent-economy/)**: Das ökonomische Ökosystem, in dem PEP-Entitäten als Akteure auftreten können
...
- **[Sovereign Stack](/sovereign-stack/)**: Der technische und philosophische Rahmen für dezentrale digitale Selbstbestimmung, in den PEP eingebettet ist
