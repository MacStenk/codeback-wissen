/**
 * CodeBack Wissen Auto-Sign Script
 * 
 ...
 *   BUNKER_KEY_NAME  - Name des Keys zum Signieren (default: codeback)
...
const CONFIG = {
  ...
  baseUrl: process.env.BASE_URL || 'https://wissen.codeback.de',
  ...
  bunker: {
    ...
    keyName: process.env.BUNKER_KEY_NAME || 'stevennoack',
  },
